...
class SKAXPhysicalRiskAnalyzer:
	...
	Super Agent 계층 구조: 18개 Sub Agent
	- Physical Risk Score (9개): H×E×V 기반 리스크 점수 계산
	- AAL Analysis (9개): 확률×손상률 기반 재무 손실률 계산
	- 병렬 실행: 두 분석이 동시에 진행됨
	"""
	...
	def analyze(
		...
		Returns:
			분석 결과 딕셔너리
				...
				- physical_risk_scores: 물리적 리스크 점수 (9개, H×E×V 기반)
				- aal_analysis: AAL 분석 결과 (9개, 확률×손상률 기반)
