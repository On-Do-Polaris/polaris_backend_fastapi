        ...
        blocks = [
            {
                ...
                "content": (
                    ...
                    "이사회는 ESG 위원회를 통해 기후 리스크를 전문적으로 검토하고 있으며, "
            ...
            },
            {
                ...
                "content": (
                    ...
                    "CSO(Chief Sustainability Officer)가 기후 리스크 관리를 총괄하며, "
                    "각 사업부 리스크 담당자와 협력하여 통합 대응 전략을 실행하고 있습니다."
                )
            }
        ]
    ...
    def _create_metrics_section(self, scenarios: Dict) -> Dict:
        ...
        blocks.append({
            ...
            "content": (
                ...
                "1. **단기 목표 (2026년)**: Top 5 리스크 AAL 10% 감소\n"
                "   - 우선순위 대응 조치 실행 (침수 방지 시설, 비상 대응 매뉴얼)\n"
                "   - 분기별 AAL 모니터링 및 진행 상황 보고\n\n"
                "2. **중기 목표 (2026-2030년)**: 포트폴리오 AAL 25% 감소\n"
                "   - 구조적 리스크 저감 투자 (방수벽, 냉각 시스템 업그레이드)\n"
                "   - 기후 회복력 기준 적용 (신규 사업장)\n\n"
                "3. **장기 목표 (2050년)**: Net-Zero 및 기후 중립 포트폴리오 달성\n"
                "   - 고위험 사업장 재배치 또는 철수\n"
                "   - 재생에너지 100% 전환 및 탄소 포집 기술 도입\n\n"
                "이러한 목표는 정기적으로 검토되며, IPCC 최신 보고서 및 국가 기후 정책 변화에 따라 조정됩니다."
            )
        })
