...
- 🏥 **API 캐시**: 오프라인 분석을 위한 9개 외부 API 데이터셋 사전 캐시
...
- **출력**: `tamax_data`, `tamin_data` (각 ~7.36M 행)
- **시간**: ~30-60분
...
- **출력**: `csdi_data`, `wsdi_data`, `rx1day_data`, `rx5day_data`, `cdd_data`, `rain80_data`, `sdii_data`
- **행**: 테이블당 ~36M (451,351 격자 × 80년)
- **시간**: ~1-2시간
