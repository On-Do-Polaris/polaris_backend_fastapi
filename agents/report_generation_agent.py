...
class ReportGenerationAgent:
    ...
    def _generate_metadata(self, location: Dict) -> Dict:
        ...
        """
        return {
            'report_title': 'SKAX 물리적 리스크 분석 리포트',
            'location': location,
    ...
    def _generate_recommendations(self, analysis_results: Dict) -> Dict:
        ...
        for risk in top_risks:
            recommendations['monitoring_priorities'].append(
                f"{risk['risk_type']} 리스크 지속 모니터링 필요 (스코어: {risk['score']:.1f})"
            )
    ...
    def _describe_methodology(self) -> str:
        """방법론 설명"""
        return "SKAX 물리적 리스크 분석은 TCFD 권고안을 기반으로 하며..."
    ...
    def _create_glossary(self) -> Dict:
        ...
        return {
            ...
            'Hazard': '위해성 - 기후 현상의 강도와 빈도',
            'Exposure': '노출도 - 자산, 인구, 인프라의 위치와 규모',
            'Vulnerability': '취약성 - 적응 능력과 민감도'
        }
